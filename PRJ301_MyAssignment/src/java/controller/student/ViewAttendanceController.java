...
public class ViewAttendanceController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        ArrayList<Registration> registrations = registrationDB.getRegistrationByStudentIdAndSemesterId("HE171819", semesterId);
        ...
        ArrayList<AttendanceRecord> attrs = attrsDB.getAttendanceRecordsBysIdAndsubIdAndseId("HE171819", subjectId, semesterId);
